...
// AuthRepo call methods
// Actual logic of these methods are in the firebase repository
// Cubit is responsible for emitting the different states
...
class AuthCubit extends Cubit<AuthState> {
  ...
  Future<String> forgotPassword(String email) async{
    try{
      final message = await authRepo.sendPasswordResetEmails(email);
      return message;
    }catch (e){
      return e.toString();
    }
